...
public class MoveLeftOperator extends Operator{
	...
	public MoveLeftOperator(es.deusto.ingenieria.aike.footprint.MoveRightOperator.Foot foot)
	{
		super(("Move Left - foot " + foot), 1d);
		this.foot = foot;
	}
	...
	protected boolean isApplicable(State state) {
		...
		System.out.println("cp left: " + currPos.getY() + "," + currPos.getX());
		switch (this.foot)
		{
			case RIGHT:
